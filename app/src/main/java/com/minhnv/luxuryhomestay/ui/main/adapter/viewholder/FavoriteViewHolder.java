...
public class FavoriteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(Favorite favorite, UserActionListener callBack){
        ...
        imgFavorite.setOnClickListener(view ->
            callBack.onActionAddFavoriteByUser(getAdapterPosition())
        );
    }

    public interface UserActionListener {
        void onActionAddFavoriteByUser(int position);
    }
